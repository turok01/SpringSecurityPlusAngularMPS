...
import com.Igor.SpringMPS.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository;
import com.Igor.SpringMPS.security.oauth2.OAuth2AuthenticationFailureHandler;
import com.Igor.SpringMPS.security.oauth2.OAuth2AuthenticationSuccessHandler;
    ...
    */
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/login", "/registrationRush")
                    .permitAll()
                .anyRequest()
                    .authenticated()
                    .and()
